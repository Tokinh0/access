...
class AccessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post accesses_url, params: { access: { ip: @access.ip, latitude: @access.latitude, longitude: @access.longitude } }
    end
  ...
  test "should update access" do
    patch access_url(@access), params: { access: { ip: @access.ip, latitude: @access.latitude, longitude: @access.longitude } }
